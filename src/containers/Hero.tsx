...
export default function Hero() {
  ...
  return (
    <>
      <section className="relative min-h-[90vh] flex items-center justify-center bg-gradient-to-br from-gray-900 via-gray-800 to-indigo-900">
            ...
            <div className="space-y-10 animate-slide-up">
              <div className="space-y-6">
                <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight">
                  <span className="text-white inline-block mb-2 overflow-visible leading-normal">Full-Stack</span>
                  <span className="block text-transparent bg-clip-text bg-gradient-to-r from-hero-primary via-hero-secondary to-hero-accent overflow-visible leading-normal">Engineer</span>
                </h1>
