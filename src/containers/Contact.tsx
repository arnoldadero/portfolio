...
export default function Contact() {
  ...
  return (
    <>
      <section id="contact" className="py-20 min-h-screen bg-gradient-to-b from-white via-indigo-50/30 to-white relative">
        ...
        <div className="max-w-6xl mx-auto px-6 relative">
          <div className="max-w-2xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="overflow-visible leading-normal text-4xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent mb-6">
